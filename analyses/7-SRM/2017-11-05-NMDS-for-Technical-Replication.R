...
SRMAreas <- read.csv("analyses/7-SRM/2017-11-05-Gigas-SRM-Good-Samples-Total-Area.csv", na.strings = "#N/A") #Specify Skyline's special way of designating N/A values
...
sequenceFile <- read.csv("analyses/7-SRM/2017-07-28-SRM-Samples-Sequence-File.csv", na.strings = "N/A") # Import sequence file
...
source("analyses/7-SRM/biostats.R") #Either load the source R script or copy paste.
